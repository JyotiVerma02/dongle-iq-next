...
export default function AdminApplicationEditor({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 px-5 pb-6 sm:px-6">
      <section
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Field label="eKYC PIN">
            <input
              ...
              onChange={(event) => handleChange("ekycPin", event.target.value)}
              className="w-full rounded-xl border px-4 py-3 text-sm outline-none"
              style={inputStyle}
            />
          </Field>
          ...
          <Field label="Certificate Type">
            <select
              ...
              onChange={(event) => handleChange("certType", event.target.value)}
              className="w-full rounded-xl border px-4 py-3 text-sm outline-none"
              style={inputStyle}
            >
              ...
              <option value="Signing & Encryption">Signing & Encryption</option>
            </select>
          </Field>
          <Field label="Validity">
            <select
              value={formData.validity || ""}
              onChange={(event) => handleChange("validity", event.target.value)}
              className="w-full rounded-xl border px-4 py-3 text-sm outline-none"
              style={inputStyle}
            >
              <option value="">Select</option>
          ...
          <Field label="USB Token">
            <select
              ...
              onChange={(event) => handleChange("tokenType", event.target.value)}
              className="w-full rounded-xl border px-4 py-3 text-sm outline-none"
              style={inputStyle}
            >
